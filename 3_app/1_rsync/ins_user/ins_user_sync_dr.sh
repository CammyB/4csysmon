...
EXCLUDE=$DEFPATH/1_rsync/ins_user/ins_user_sync_dr.exclude
LOG=$DEFPATH/1_rsync/ins_user/ins_user_sync_dr.log
FSLIST=$DEFPATH/1_rsync/ins_user/ins_user_sync_dr.include
LOGTMP=/4csysmon/1_unix/7_temp/ins_user_sync_dr.tmp
