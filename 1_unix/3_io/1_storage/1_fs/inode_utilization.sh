...
LOGDES="fs_inode_utilization"
LOG=$DEFPATH/3_io/1_storage/1_fs/inode_utilization.log
INODETHRESH=$DEFPATH/6_misc/inodes_thresholds.list
TMP=$DEFPATH/7_temp/fs_inode.tmp
MARKER=$DEFPATH/7_temp/fs_inode_utilization.tmp
...
df -oi -F ufs |awk '{print $4,$5}' |grep -v Mounted > $TMP
